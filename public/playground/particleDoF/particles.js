...
function animate() {
	...
	//emitters[0].particle.velocity = Math.sin(time/200) * 50 + 60;
...
function createPanel() {
	...
	folder1.add(text, 'e.physics.gravity',-10,10).step(0.1).onChange(function(v){emitters[ae].physics.gravity = v});
